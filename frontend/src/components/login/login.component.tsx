  ...
  return (
    <div className="min-h-screen w-full bg-white dark:bg-[#0B1120] text-slate-900 dark:text-slate-100 flex items-center justify-center relative overflow-hidden px-4 py-8 sm:px-6 lg:px-8 box-border">
      ...
      <div className="w-full max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10 box-border">
        ...
        {/* Left Column — Feature Highlights (Hidden on Mobile) */}
        <motion.div
        ...
        >
          ...
          <div className="flex justify-start items-center gap-6 border border-gray-300 dark:border-slate-700 rounded-2xl p-4 bg-slate-50 dark:bg-slate-800 dark:text-gray-400">
          ...
          <div className="flex justify-start items-center gap-6 border border-gray-300 dark:border-slate-700 rounded-2xl p-4 bg-slate-50 dark:bg-slate-800 dark:text-gray-400">
            ...
            <div>
              <h2 className="font-bold text-slate-800 dark:text-slate-200">Endless Creativity</h2>
          ...
          <div className="flex justify-start items-center gap-6 border border-gray-300 dark:border-slate-700 rounded-2xl p-4 bg-slate-50 dark:bg-slate-800 dark:text-gray-400">
            ...
            <div>
              <h2 className="font-bold text-slate-800 dark:text-slate-200">Built for everyone</h2>
          ...
          <motion.div 
            ...
            className="bg-slate-50 dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-2xl p-4 shadow-2xl w-full min-w-0 box-border"
          >
        ...
        <div className="flex justify-center w-full box-border">
          <div className="w-full max-w-md bg-slate-50 dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-2xl box-border overflow-hidden relative mx-auto">
            ...
            <button
              ...
              className="mb-4 text-sm text-blue-500 hover:text-blue-400 transition-colors duration-200 flex items-center gap-2 cursor-pointer bg-transparent border-none p-0"
            >
              &larr; Back to Home
            </button>
            ...
            <div className="relative my-6 w-full box-border">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-slate-50 dark:bg-[#151f32] px-4 text-slate-400 font-semibold tracking-wide">
                  Or
                </span>
              </div>
            </div>
